...
import express.mvp.myra.codec.schema.*;
...
/** Tests schema resolution behavior used by codegen. */
class SchemaResolverTest {
    ...
    @Test
    void resolve_ShouldPropagateFixedCapacityMetadata() {
        SchemaDefinition schema =
                new SchemaDefinition(
                        "com.test",
                        "1.0.0",
                        List.of(
                                new MessageDefinition(
                                        ...
                                        List.of(
                                                new FieldDefinition(
                                                        1, "symbol", "string", false, false, false,
                                                        "", 16)))),
                        List.of());
        ...
        ResolvedFieldDefinition field =
                result.resolvedSchema().messages().getFirst().fields().getFirst();
        assertEquals(16, field.fixedCapacity());
    }
