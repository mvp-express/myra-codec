...
/**
 * Auto-generated enum for TradingStatus.
 *
...
public enum TradingStatus {
    ...
    private static final TradingStatus[] VALUES_BY_ID;

    static {
        VALUES_BY_ID = new TradingStatus[3];
        for (TradingStatus e : values()) {
            VALUES_BY_ID[e.id] = e;
        }
    }
    ...
    public static TradingStatus fromIdOrNull(int id) {
        if (id < 0 || id >= VALUES_BY_ID.length) {
            return null;
        }
